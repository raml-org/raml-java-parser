...
public class ValidationResult {
	...
	private ValidationResult(Level level, String message, int line,
	...
	public static List<ValidationResult> getLevel(Level level,
	...
	public String toString() {
		return "ValidationResult{" + "level=" + level + ", message='" + message
				+ '\'' + '}';
	}
	...
	public static ValidationResult createErrorResult(String message, int line,
			int startIndex, int endIndex) {
		return new ValidationResult(Level.ERROR, message, line, startIndex,
				endIndex);
	}

	public static ValidationResult createErrorResult(String message,
			Mark startMark, Mark endMark) {
		return createErrorResult(message, startMark.getLine(),
				startMark.getColumn(), endMark.getColumn());
	}

	public static ValidationResult createErrorResult(String message, Node node) {
		return createErrorResult(message, node.getStartMark(),
				node.getEndMark());
	}
	...
	public static ValidationResult createWarnResult(String message, Node node) {
		return new ValidationResult(Level.WARN, message, node.getStartMark()
				.getLine(), node.getStartMark().getColumn(), node.getEndMark()
				.getColumn());
	}
